...
app.get('/obtener-usuarios', async (request, response) =>{
   ...
   const resultado = await filesystem.promises.readFile('./public/usuarios.json', {encoding: 'utf8'});// Lee el archivo
   const usuarios = JSON.parse(resultado) // Transformo el json a objeto con el metodo parse
